...
1. Check the *languages* folder of [https://github.com/fe-data/fe-admin-languages](https://github.com/fe-data/fe-admin-languages) if your language is supported.
1. If not, login with your Github account at [https://gitlocalize.com/repo/9558](https://gitlocalize.com/repo/9558) and check if the translation is in progress.
1. If not, create a new issue in [https://github.com/fe-data/fe-admin-languages/issues](https://github.com/fe-data/fe-admin-languages/issues) requesting the new language code. We will give you the role of moderator for the new language. Use the two letter codes from [this source](http://www.loc.gov/standards/iso639-2/php/code_list.php). Only LTR-languages are supported.
...
1. Once the pull request has been processed, the new translation will be available in the app’s settings. Reload the translations and select the new language.
